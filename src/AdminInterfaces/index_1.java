...
public class index_1 extends javax.swing.JFrame {
    ...
    private void viewdata(){
        ...
        try{
            ...
            System.out.println("Error in quering data about books. Error = "+e.getMessage());
        }
    }
    private void view_data(){
       String pp=status_box.getText();
        ...
        if(pp.length() == 0){
            ...
            sql = "SELECT id AS ID,name AS Name,author AS Author,description as Description,status AS Status FROM book WHERE  status = '"+pp+"'";
        }
    ...
    private void initComponents() {
        ...
        jLabel7.setBounds(690, 430, 60, 20);
        getContentPane().add(status_box);
        status_box.setBounds(160, 410, 110, 30);
        ...
        jButton3.setBounds(280, 410, 100, 30);
        ...
        jLabel8.setBounds(750, 10, 30, 30);

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/Adimn_book_view.jpg"))); // NOI18N
