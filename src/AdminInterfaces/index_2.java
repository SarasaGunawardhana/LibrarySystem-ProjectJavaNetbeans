...
public class index_2 extends javax.swing.JFrame {
    ...
    private void addBook(){
        ...
        String author = author_box.getText();
        ...
        if(Name.equals(""))
            ...
            JOptionPane.showConfirmDialog(null,"Enter Author.");
        else if(Description.equals(""))
            JOptionPane.showConfirmDialog(null,"Enter description.");
        else if(Status.equals(""))
            JOptionPane.showConfirmDialog(null,"Enter status.");
        else{
            String sql = "INSERT INTO book(name,author,description,status) VALUES ('"+Name+"','"+author+"','"+Description+"','"+Integer.parseInt(Status)+"') ";
            try{
                ...
                System.out.println("Error in inserting New book. Error = "+e.getMessage());
            }
        }
    ...
    private void initComponents() {
        ...
        getContentPane().add(author_box);
        author_box.setBounds(280, 180, 200, 30);
        ...
        jLabel7.setBounds(630, 370, 100, 30);
        ...
        jLabel8.setBounds(680, 420, 60, 20);
        ...
        jLabel9.setBounds(750, 10, 30, 30);

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/Admin_Add.jpg"))); // NOI18N
