...
public class index_3 extends javax.swing.JFrame {
    ...
    private void setdata(){
        String sql = "SELECT id AS ID,name AS Name,author AS Author,description as Description,status AS Status FROM book";
        try{
            ...
            System.out.println("Error in quering data about book. Error = "+e.getMessage());
        }
    }
    ...
    private void view_data(){
       String pp=jTextField1.getText();
        ...
        if(pp.length() == 0){
            sql = "SELECT id AS ID,name AS Name,author AS Author,description as Description,status AS Status FROM book WHERE status = 0";
        }
        else{
            sql = "SELECT id AS ID,name AS Name,author AS Author,description as Description,status AS Status FROM book WHERE  name LIKE '%"+pp+"%'";
        }
    ...
    {
      int cl,s,ids;
        String name,status,author,description;
        name = name_box.getText();
        status = status_box.getText();
        author = author_box.getText();
        ...
        if(name.equals(""))
            ...
            String sql = "UPDATE course SET name = '"+name+"',conductor = '"+author+"',description = '"+description+"',status = "+s+" WHERE id = "+ids+"";
            ...
            try{
                ...
                System.out.println("Error in update book table. Error = "+e.getMessage());
            }
        }
    ...
    private void initComponents() {
        ...
        author_box.setBounds(200, 150, 170, 30);
        ...
        jLabel8.setBounds(750, 10, 40, 30);

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/Admin_update.jpg"))); // NOI18N
