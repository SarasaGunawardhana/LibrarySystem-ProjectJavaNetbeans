...
public class signup extends javax.swing.JFrame {
    ...
    private void signup_work(){
        ...
        String fname,sname,email,telephone,dob_d,dob_m,dob_y,username,confirm_code;
        ...
        confirm_code=confirm_box.getText();
        ...
        if(fname.equals(""))
            ...
            JOptionPane.showConfirmDialog(null,"Enter Confirmation Code");
            ...
            JOptionPane.showConfirmDialog(null,"Enter Reconfirm Password");
             ...
             String cc="SELECT id FROM confirm_code WHERE confirm_code='"+confirm_code+"'";
            try{
                ...
                if(ccsize==0)
                {
                   JOptionPane.showConfirmDialog(null,"Check again,your confirmation code is wrong"); 
                }
                else
                {
                        ...
                        if(!username.equals(""))
                        {
                            ...
                            else if(!passString.equals(re_passString))
                            {
                                ...
                                System.out.println("Error in searching confirmation code. Error = "+e.getMessage());
                            }
    ...
    private void initComponents() {
        ...
        confirm_box = new javax.swing.JTextField();
        ...
        fname_box.setFont(new java.awt.Font("Berlin Sans FB Demi", 0, 11)); // NOI18N
        ...
        fname_box.setBounds(230, 150, 150, 30);
        ...
        lname_box.setBounds(230, 200, 150, 30);
        getContentPane().add(email_box);
        email_box.setBounds(230, 250, 150, 30);

        tele_box.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                tele_boxActionPerformed(evt);
            }
        });
        ...
        tele_box.setBounds(230, 300, 150, 28);
        getContentPane().add(confirm_box);
        confirm_box.setBounds(230, 430, 150, 30);
        ...
        dob_dd_box.setBounds(230, 340, 51, 32);
        ...
        dob_mm_box.setBounds(280, 340, 51, 32);
        ...
        dob_yy_box.setBounds(330, 340, 50, 32);
        ...
        jLabel5.setBounds(740, 10, 30, 40);

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/registration.jpg"))); // NOI18N
        getContentPane().add(jLabel1);
        jLabel1.setBounds(0, 0, 800, 500);

        setSize(new java.awt.Dimension(800, 483));
    ...
    private void tele_boxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tele_boxActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_tele_boxActionPerformed
    ...
    private javax.swing.JTextField confirm_box;
